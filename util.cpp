...
GLuint crearTextura2DVec1(unsigned tam, const float* datos) {
    GLuint tex;
    ...
    glTexImage2D(GL_TEXTURE_2D, 0, GL_R32F, SIM_ANCHO_TEXTURA_DATOS, ceil((float)tam / SIM_ANCHO_TEXTURA_DATOS), 0, GL_RED, GL_FLOAT, datos);
    glBindTexture(GL_TEXTURE_2D, 0);
