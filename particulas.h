...
class ParticulasApp : public GLFWWindow {
    ...
    const GLuint colorParam = 1;

    /** VAO & array de vértices para particulas */
    GLuint vaoSim, vboSimCoords, vboColorParticulas;
    ...
    std::vector<vec3> colorParticulas;
